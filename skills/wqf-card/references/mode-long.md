...
Read `~/.claude/skills/wqf-card/assets/long_template.html`
...
写入：`/tmp/wqf_cast_long_{name}.html`

## 步骤 5：截图

```bash
node ~/.claude/skills/wqf-card/assets/capture.js /tmp/wqf_cast_long_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
