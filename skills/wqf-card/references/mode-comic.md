...
Read `~/.claude/skills/wqf-card/assets/comic_template.html`
...
写入：`/tmp/wqf_cast_comic_{name}.html`
...
```bash
node ~/.claude/skills/wqf-card/assets/capture.js /tmp/wqf_cast_comic_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
