...
Read `$SKILL_DIR/assets/sketchnote_template.html`
...
```bash
node $SKILL_DIR/assets/capture.js /tmp/wqf_cast_sketchnote_{name}.html ~/Downloads/{name}.png 1080 800 fullpage
```
